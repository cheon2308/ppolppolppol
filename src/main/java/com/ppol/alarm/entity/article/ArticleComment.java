...
import com.ppol.alarm.entity.global.BaseComment;
...
public class ArticleComment extends BaseComment {
	...
	// Builder
	@Builder
	public ArticleComment(Long id, String content, User writer, Article article, long parent, List<Long> tagUserList,
